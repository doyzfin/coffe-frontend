    ...
    <div className="row pt-5">
      <div className="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <div className="d-flex justify-content-start mb-4" style={{ height: "33px"}}>
          ...
          <span className="d-block fw-bold my-1">Coffee Shop is a store that sells some good</span> 
          <span className="d-block fw-bold my-1">meals, and especially coffee. We provide</span> 
